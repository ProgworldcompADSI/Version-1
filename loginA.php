...
<br>
        ...
        <div class="card card-container">
            <br><br>
            <img id="profile-img" class="profile-img-card" src="imagenes/admin.png" width="200" height="200" />
            <p id="profile-name" class="profile-name-card"></p>
            <br><br>
            
 <form name="areat" method="post"action="loginA2.php">

         
<input type="number" class="in" name="documentosa" placeholder="Documento" required autofocus style="width:350px; height:40px"> 
<br><br>
<input type="password" class="in" name="contrasenasa" placeholder="Contraseña" required autofocus style="width:350px; height:40px"> 
<br><br>
