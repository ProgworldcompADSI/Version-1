...
<br><br>
 ...
 $registro=$mysql->query("SELECT usuario.nombre,usuario.apellido,usuario.documento,idreservas, fecha, hora, servicio,precio,usuario, empleado,estado FROM reservas INNER JOIN usuario ON reservas.usuario=usuario.documento where fecha =CURRENT_DATE() and  reservas.estado='activo'") or
 die($mysql->error);
 ...
 echo $reg['estado'];
  echo '<td WIDTH="500">';
echo "<font color='#CC0000'><a href='reservadoa1.php?idreservas=$reg[idreservas] '>CANCELAR <img src='imagenes/ex.png' width='30' height='30'></a>";
 echo '<td WIDTH="500">';
echo "<font color='#CC0000'><a href='reservadoa1.php?idreservas=$reg[idreservas] '>REALIZADO <img src='imagenes/chulo.png' width='30' height='30'></a>";
 echo '</td></tbody>';
