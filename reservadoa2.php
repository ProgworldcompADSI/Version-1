...
<br><br>
 ...
 <form name="areat" method="post"action="reservadoa2.php">

 CEDULA A CONSULTAR:     
<input type="text" class="form-control" name="documentosa" placeholder="documento" required autofocus style="width:350px; height:40px"> 
<br>
...
<br><br>
 ...
 $d1=($_SESSION['usuario']);
 $a2=($_SESSION['clave']);
  $a3=($_POST['documentosa']);
 
 $registro=$mysql->query("SELECT usuario.nombre,usuario.apellido,usuario.documento,idreservas, fecha, hora, servicio,precio,usuario, empleado,estado FROM reservas INNER JOIN usuario ON reservas.usuario=usuario.documento where usuario.documento= '$a3'") or
 die($mysql->error);
 
   echo '<table class="tabla1">';
   
 echo '<tr ><thead><th><center> CLIENTE  </th><th>   IDENTIFICACION </th><th><center>  FECHA  </th><th>  HORA </th> <th>SERVICIO </th><th>PRECIO </th><th>EMPLEADO </th><th>ESTADO </th><th> </th><th> </th></tr></thead>';
 ...
 echo $reg['estado'];
  echo '<td WIDTH="500">';
echo "<font color='#CC0000'><a href='reservadoa2.php?&idreservas=$reg[idreservas] '>CANCELAR <img src='imagenes/ex.png' width='30' height='30'></a>";
 echo '<td WIDTH="500">';
echo "<font color='#CC0000'><a href='reservadoa2.php?idreservas=$reg[idreservas] '>REALIZADO <img src='imagenes/chulo.png' width='30' height='30'></a>";
 echo '</td></tbody>';
