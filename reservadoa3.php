...
<br><br>
 ...
 $registro=$mysql->query("SELECT usuario.nombre,usuario.apellido,usuario.documento,idreservas, fecha, hora, servicio,precio,usuario, empleado,estado FROM reservas INNER JOIN usuario ON reservas.usuario=usuario.documento") or
 die($mysql->error);

   echo '<table class="tabla1">';
 echo '<tr ><thead><th><center> CLIENTE  </th><th>   IDENTIFICACION </th><th><center>  FECHA  </th><th>  HORA </th> <th>SERVICIO </th><th>PRECIO </th><th>EMPLEADO </th><th>ESTADO </th></tr></thead>';
